...
import { updateEvent, uploadImage, fetchDestinations } from '../../services/admin.service';
  ...
  useEffect(() => {
    if (event) {
      setForm({
        ...
        imageFile: null,
        imagePreview: event.coverPhoto || null,
      });
      setErrors({});
    }
  }, [event]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let coverPhoto = form.imageFile
        ? await uploadImage(form.imageFile, 'localtrip/events')
